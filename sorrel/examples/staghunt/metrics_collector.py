...
if TYPE_CHECKING:
    from .staghunt_agent import StagHuntLLMAgent
...
class StagHuntMetricsCollector:
    ...
    def collect_agent_positions(self, agents: List[StagHuntLLMAgent]) -> None:
    ...
    def collect_punishment_metrics(self, punisher: StagHuntLLMAgent, 
                                  target: StagHuntLLMAgent) -> None:
    ...
    def collect_agent_cost_metrics(self, agent: StagHuntLLMAgent, attack_cost: float = 0.0, 
    ...
    def collect_resource_defeat_metrics(self, agent: StagHuntLLMAgent, shared_reward: float, resource_type: str = None) -> None:
    ...
    def collect_shared_reward_metrics(self, agent: StagHuntLLMAgent, shared_reward: float) -> None:
    ...
    def log_epoch_metrics(self, agents: List[StagHuntLLMAgent], epoch: int, writer) -> None:
